	...
	<div class="container">
		<form action="transfer.php" method="post">
			...
			<datalist id="names">
				...
				<option value="Mohit Jain"></option>
				<option value="Raunak Singh Matharu"></option>
				<option value="Nivedita Mishra"></option>
				<option value="Ritik Bhandari"></option>
				<option value="Harshad Kolhe"></option>
				<option value="Yash Pandey"></option>
				<option value="Rachit Shah"></option>
				<option value="Ritika Jaiswal"></option>
